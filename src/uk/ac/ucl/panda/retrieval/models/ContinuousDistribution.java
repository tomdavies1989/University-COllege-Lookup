...
public abstract class ContinuousDistribution implements Distribution {
	 ...
	 * <I>F</I>(<I>x</I>)</SPAN>, which is not accurate when <SPAN
	 * CLASS="MATH"><I>F</I>(<I>x</I>)&nbsp;-&gt;&nbsp;1</SPAN>.
	 * 
	 * @param x
	...
	/**
	 * Computes and returns the inverse distribution function <SPAN
	 * CLASS="MATH"><I>x</I> = <I>F</I><SUP>-1</SUP>(<I>u</I>)</SPAN>, by
	 * calling the method {@link #inverseBrent inverseBrent}. Restrictions:
